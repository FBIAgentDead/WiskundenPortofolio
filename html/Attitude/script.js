...
let A = new Point(500,98,15,"orange");
let C = new Point(600,200,15,"blue");
let D = new Point(600,400,15,"red");

let S = new Point(0,0,5,"blue");
let ST = new Point(0,0,5,"blue");
let STA = new Point(0,0,5,"blue");
let SNIJ = new Point(0,0,5, "blue");
